...
export function SiteHeader({active}:{active?:"home"|"about"|"services"}){
  ...
  return <header className={`siteHeader${active==="services"?" servicesHeader":""}`}>
    ...
    <div className="navBar">
      <a href="/" className="brand" aria-label="Arizona Commercial Property Inspections home"><img src="/ArizonaCommercialPropertyInspections-logo.webp" alt="Arizona Commercial Property Inspections"/><span>Arizona Commercial Property Inspections</span></a>
      <nav id="main-navigation" className={menuOpen ? "mobileOpen" : undefined} aria-label="Main navigation" onClick={(event) => { if ((event.target as HTMLElement).closest("a")) setMenuOpen(false); }}>
        ...
        <div className="navDropdown">
          <a className={active==="services"?"active":undefined} href="/inspection-services/" aria-expanded={servicesOpen} aria-controls="services-submenu" onClick={(event) => { if (window.matchMedia("(max-width: 980px)").matches && !servicesOpen) { event.preventDefault(); setServicesOpen(true); } }}>SERVICES <HeaderIcon name="chevron" /></a>
      ...
      <a className="request" href="/schedule-an-inspection/"><span className="requestText">REQUEST INSPECTION</span><HeaderIcon name="calendar" /></a>
...
export function SiteFooter(){return <footer id="contact"><div className="footerTop"><div className="footerBrand"><img src="/ArizonaCommercialPropertyInspections-logo.webp" alt="Arizona Commercial Property Inspections"/><p>Clarity for every commercial property decision.</p></div><div className="footerContacts"><div><i><FooterActionIcon name="phone" /></i><h4>CALL US</h4><p><a href="tel:1-480-808-1170">(480) 808-1170</a></p></div><div><i><FooterActionIcon name="email" /></i><h4>EMAIL US</h4><p><a href="mailto:arizonacpi@gmail.com">arizonacpi@gmail.com</a></p></div><div><i><FooterActionIcon name="calendar" /></i><h4>REQUEST INSPECTION</h4><p><a href="/schedule-an-inspection/">Start Your Request</a></p></div></div><div className="footerBottom"><p className="legal"><span>© {new Date().getFullYear()} Arizona Commercial Property Inspections</span><a href="/privacy-policy/">Privacy Policy</a><a href="/terms-of-service/">Terms of Service</a></p><div className="social"><a href="https://www.google.com/maps/place/Arizona+Commercial+Property+Inspections" aria-label="Google">G</a><a href="https://www.instagram.com/azcpi/" aria-label="Instagram"><InstagramIcon /></a><a href="https://www.facebook.com/Arizonainspections/" aria-label="Facebook">f</a><a href="https://www.youtube.com/@arizonacommercialinspections" aria-label="YouTube">▶</a></div></div></div></footer>}
